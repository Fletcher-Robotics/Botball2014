...
/// The connect link function
// @function connect
// @see connect #Create_serial_interface
...
// @function disconnect
// @see disconnect #Create_serial_interface
...
// @see drive_straight #Create_movement
// @tparam int speed speed (-500 - 500)
