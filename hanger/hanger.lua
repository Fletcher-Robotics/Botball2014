...
function green_hanger()
    ...
    create.spin_angle(160, -87) -- Spin toward hangars
    create.drive_segment(150, 200) -- Move to the hangars
    ...
    claw:half_open() claw:bmd() -- Drop the hangars
end
...
function first_blue_hanger()
    ...
    create.drive_segment(260, 395) -- Move all the way to the left blue hangar
    ...
    -- Go for blue one
    claw:closed() claw:bmd() -- Close the claw
    arm:over_botbar() -- Begin moving up over the bottom bar
    msleep(330) -- Let the arm begin moving up
    create.drive_segment(100, -235) -- Move back, clearing the bottom bar
...
function second_blue_hanger()
    ...
    create.drive_segment(250, 165) -- Go straight parallel to pipe
    create.drive_arc(240, -180, -45) -- Sepentine to right hangar
    create.drive_arc(240, 180, 36)
    create.force_wait()
    reset_position()
    ...
    -- Go for second blue
    claw:closed() claw:bmd() -- Capture blue hangar
    ...
    create.force_wait()
    claw:more_open() claw:bmd() -- Release the hanger
